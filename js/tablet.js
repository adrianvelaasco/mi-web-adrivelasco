document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        ...
        es: {
            ...
            cvLink: "assets/CVs/CV_Español.pdf"
        }
    };
        ...
        if (filter === 'others') {
            filtered.forEach(work => {
                if (work.embed) {
                    ...
                    const link = work.link ? work.link : `works/viewer_tablet.html?work=${work.id}`;
            ...
            years.forEach(year => {
                ...
                filtered.filter(w => w.year === year).forEach(work => {
                    const link = work.link ? work.link : (work.id === 'meinzuhause' ? 'meinzuhause.html' : `works/viewer_tablet.html?work=${work.id}`);
                    const target = work.link ? 'target="_blank"' : '';
                    html += `
